...
<body background="image\bg.png">
	...
	<div id="epicture">
		<form action="edit_profile.php" method="POST" enctype="multipart/form-data">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: ;font-size:60px; font-family:URW Chancery L, cursive;background-color:green;"> * Edit Profile Picture * </th></tr>
	...
	<div id="ename">
		<form action="edit_profile.php" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: ;font-size:60px; font-family:URW Chancery L, cursive;background-color:green;"> * Edit Name * </th></tr>
				<tr><td><img src="image/divide.jpg" height="40%" width="100%" style="opacity: 0.6"></td></tr>
	...
	<div id="eemail">
		<form action="edit_profile.php" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: ;font-size:60px; font-family:URW Chancery L, cursive;background-color:green;"> * Edit E-mail * </th></tr>
				<tr><td><img src="image/divide.jpg" height="40%" width="100%" style="opacity: 0.6"></td></tr>
